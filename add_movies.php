...
<div id="content">
<div id="view_admin"><img src="images/Movies-icon.png" width="128" height="128"></br>MOVIES</div>
<div id="add_admin_content" class="wrapper">
<form method="post" action="insert_admin.php" >
<label>Movie Name</label><input type="text" name="first_name" id="first_name" style="text-transform:uppercase"><br/>
...
<label>In Stock</label><select name="title" id = "title" style="text-align:left;">
    <option value = "MR">In Stock</option>
    <option value = "MS">Out of STOCK</option>
